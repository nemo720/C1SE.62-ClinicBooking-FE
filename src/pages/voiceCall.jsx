                    ...
                    <div className="call-contents">
                      <div className="call-content-wrap">
                        <div className="voice-call-avatar">
                          <img src="assets/img/doctors/doctor-thumb-02.jpg" alt="User Image" className="call-avatar" />
                          <span className="username">Bot Bác Sĩ</span>
                        ...
                        <div className="call-users">
                          <ul>
                            <li>
                              <a href="#">
                                <img src="assets/img/patients/patient1.jpg" className="img-fluid" alt="User Image" />
